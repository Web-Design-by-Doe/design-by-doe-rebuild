...
export default function IpadScrollAnimation({
  titleComponent,
  children,
}: {
  ...
  return (
    <div
      className="h-[60rem] sm:h-[70rem] md:h-[80rem] max-w-5xl flex items-center justify-center relative p-2 md:p-20 duration-300"
      ref={containerRef}
    >
      <div
